<?php 
  ...
  include('essentials/config.php');
	...
	{ ?>
        ...
        That said you have to wait untill your order gets approved. Cheers </p>
        </div>
                <a href="order-update.php" class="btn btn-sm btn-success pull-right" style="margin-left: 4px">Place In Order</a>

  ...
  <div class="container">
    <div class="row mb-5 ">
      ...
      <div class="col-md-5 pull-left">
        ...
        <div class="site-section-heading pt-5">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="block-38 text-center">
          <div class="block-38-img">
            <div class="block-38-header">
              <img src="img/" alt="Image placeholder" class="mb-4">
              <h3 class="block-38-heading h4">Person B</h3>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="block-38 text-center">
          <div class="block-38-img">
            <div class="block-38-header">
              <img src="img/" alt="Image placeholder" class="mb-4">
              <h3 class="block-38-heading h4">Person C</h3>
              <p class="block-38-subheading">Post C</p>
            </div>
            <div class="block-38-body">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
            </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="block-38 text-center">
          <div class="block-38-img">
            <div class="block-38-header">
              <img src="img/" alt="Image placeholder" class="mb-4">
              <h3 class="block-38-heading h4">Person D</h3>
              <p class="block-38-subheading">Post D</p>
            </div>
            <div class="block-38-body">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
            </div>

...
<div class="container">
    <div class="row">
        <div class="col-lg-9 mx-auto my-4 text-center">
            <h2><span class="badge badge-success">Customer Messages</span></h2>
        </div>
        <div class="col-lg-9 mx-auto text-center">
            <a href="vendorMessages.php" class="m-2 btn btn-sm btn-info">
                <i class="fa fa-exclamation-triangle mr-2"></i> <b>Vendor Messages</b></a>
            ...
            <div class="table-responsive">
                <table class='table table-borderless text-center'>
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM msg WHERE type='contact' ORDER BY msg_id DESC LIMIT $start_from, $per_page";
...
<?php
$query = "SELECT * FROM msg WHERE type='contact'";
$result = mysqli_query($connect, $query);

...
require('header.php');
$id = $_GET['id'];
$result = mysqli_query($connect, "SELECT * FROM category WHERE category_id=$id ");
                    ...
                    <h1 class="login-title mb-4">Edit category</h1>
                        <form class="form-horizontal" method="post" action="updateCategory.php" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="email" value="<?php echo $row['category_name'] ?>" required />
                            </div>

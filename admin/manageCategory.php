...
<div class="container">
    <div class="row">
        <div class="col-lg-9 mx-auto mt-5">
            <a href="addCategory.php" class="btn btn-sm btn-success pull-center">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($row['status'] == 1) {  ?>
                                        <a style="color: red; " class='disable' id='disable_<?= $row['category_id'] ?>'>
                                            <i class="fas fa-times-circle"></i></a>
                                    <?php } else { ?>
                                        <a style="color: green; " class='enable' id='enable_<?= $row['category_id'] ?>'>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.disable').click(function() {
            ...
            bootbox.confirm({
                message: "Do you really want to disable this Category ?",
                buttons: {
                    confirm: {
                        label: 'Yes',
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.enable').click(function() {
            ...
            var deleteid = splitid[1];
            bootbox.confirm({
                message: "Do you really want to enable this Category ?",
                buttons: {
                    confirm: {
                        label: 'Yes',
                        className: 'btn-success'

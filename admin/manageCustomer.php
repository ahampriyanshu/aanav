        ...
        <div class="container">
         ...
         <h2><span class="badge badge-light">Manage Customer</span></h2>
                ...
                <div class="col-lg-9 mx-auto text-center">
                    <a href="unverifiedCustomer.php" class="m-2 btn btn-sm btn-success">
                        <i class="fa fa-plus-square mr-2"></i> <b>Unverified Customer</b></a>

                        <a href="unactiveCustomer.php" class="m-2 btn btn-sm btn-danger">
                        <i class="fa fa-plus-square mr-2"></i> <b>Unactive Customer</b></a>

                        <a href="disabledCustomer.php" class="m-2 btn btn-sm btn-warning">
                        <i class="fa fa-plus-square mr-2"></i> <b>Disabled Customer</b></a>
                </div>

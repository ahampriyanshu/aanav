        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 mx-auto mt-5">
                    <a href="addProduct.php" class="btn btn-sm btn-success pull-center">
                        <i class="fa fa-plus-square mr-2"></i> <b>Add New Product</b></a>

                        <a href="renewProduct.php" class="btn btn-sm btn-success pull-center">
                        <i class="fa fa-plus-square mr-2"></i> <b>Deleted Product</b></a>
                ...
                <div class="col-lg-12 mx-auto mt-5">
                    <div class="table-responsive">
                        <table class='table table-borderless text-center'>
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT * FROM product WHERE status=1 order by id ASC";
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge  badge-info"><?php echo $row['code'] ?></span>
                                        </td>
                                        <td>
                                            <span class="badge  badge-info"><?php echo $row['qty'] ?></span>
                                        </td>
                                        <td>
                                            <span class="badge  badge-info"><?php echo $row['cost'] ?></span>
                                        </td>
                                        <td>

    ...
    <section class="checkout-section spad">
        <div class="container checkout-form">
                ...
                if (isset($_SESSION['cart'])) {
                  ...
                  <li class="fw-normal">Delivery Charge <span>&#x20B9;&nbsp; 100</span></li>
...
<div class="container">
    <p>
        <a href="shipping_del.php?id=<?php echo $row['shipping_id'] ?>"
        class='pull-right' id='del_<?= $id ?>'>Delete</a>
    ...
    <p><?php echo $row['street_address'] ?>,<?php echo $row['city'] ?>,<?php echo $row['state'] ?></p>
          
    <a href="payment.php?id=<?php echo $row['shipping_id'] ?>" class="btn btn-warning"
        style="margin: 0px 0px">Select This Address</a>
</div>
<?php
} ?>
</div>

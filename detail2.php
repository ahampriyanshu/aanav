...
<!--      ----------------------------------- SOLD OUT MODAL DIALOG ------------------------ -->
   ...
   ?>
     <button data-toggle="modal" data-target="#view-modal" data-id="<?php echo $row['id']; ?>" id="getUser" style="clear:both; background: #48c9b0; border: none; color: #fff; font-size: 14px; padding: 10px;cursor: pointer;">Add To Cart Now</button>
     <?php } ?>
                ...
                <div class="col-md-12">
                  ...
                  ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p><strong>&#x20B9;&nbsp;<?php echo $row_similar2['cost']; ?></strong></p>
                                    </div>
                                    <?php endwhile; ?>
                                </div>
                                <!--.row-->
